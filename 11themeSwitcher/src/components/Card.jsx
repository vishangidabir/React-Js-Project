...
{/* Second card  */}
            {/* <div className="w-full  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="/">
                    <img className="p-8 rounded-t-lg" src="https://img-c.udemycdn.com/course/750x422/548068_c79d_5.jpg" alt="product_image1" />
                </a>
                <div className="px-5 pb-5">
                    <a href="/">
                        <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                            The complete JavaScript Guide 2025
                        </h5>
                    </a>
                    <div className="flex items-center mt-2.5 mb-5">
                        <svg
...
{/* third Card */}
            {/* <div className="w-full  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-5">
                <a href="/">
                    <img className="p-8 rounded-t-lg" src="https://img-c.udemycdn.com/course/750x422/4471614_361e_8.jpg" alt="product_image1" />
                </a>
                <div className="px-5 pb-5">
                    <a href="/">
                        <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
